...
module.exports.init = function(cb){
  $(function(){
    var $html, required, GetVal, GetLocalText, LoadImg, values, localization, $head, $curLink, timerId, href, $newLink, timeout, failCb;
    $html = $('html');
    required = {
      lang: $html.attr('lang')
    };
    GetVal = require('./lib/get_val');
    GetLocalText = require('./lib/get_local_text');
    LoadImg = require('./lib/load_img');
    ...
    timeout = b.getVal('styles-load-timeout', true) * 1000;
    failCb = function(){
...
},{"./lib/get_local_text":4,"./lib/get_val":5,"./lib/load_img":8,"./localization":10,"./values":15,"jquery":"tpyseH"}],2:[function(require,module,exports){
// Generated by LiveScript 1.3.1
/**
...
module.exports = function(url){
  ...
  hash = _p.dropWhile((function(it){
    return it !== '#';
  }))(
  url);
  hashId = _p.drop(1)(
  hash);
  correctHash = /^[a-zA-Z0-9-_]+$/.test(hashId);
  if (!correctHash) {
    return false;
  }
  return $(hash).length > 0;
};
},{"jquery":"tpyseH","prelude":"iujHG2"}],3:[function(require,module,exports){
// Generated by LiveScript 1.3.1
/**
 * Header
 *
 ...
 * @see {@link https://github.com/web-izmerenie/wi-site/blob/master/LICENSE-AGPLv3|License}
 */
var $, b, linkHandler, hasElByHash, $w, $html, $page, $body, $header, $logo, $callMenu, $menu, $nav, $navLinks, $heightHelper, $cards, mainPage;
$ = require('jquery');
b = require('./basics');
...
(function(){
  var bindSuffix, resizeHandler, lastScrollTop, scrollHandler;
  bindSuffix = '.header-menu-vertical-scroll';
  resizeHandler = function(){
    if ($nav.innerHeight() <= $w.height()) {
      $nav.removeClass('scroll').css('top', '');
      return 'no-scroll';
    }
    $nav.addClass('scroll');
  };
  ...
  scrollHandler = function(){
    var st, top, h, wh, newTop, ws;
    if (resizeHandler() === 'no-scroll') {
      return;
    }
    st = $w.scrollTop();
    top = parseInt($nav.css('top'), 10);
    h = $nav.innerHeight();
    wh = $w.height();
    newTop = top - (st - lastScrollTop);
    ws = -(h - wh);
    if (newTop > 0) {
      newTop = 0;
    }
  ...
  $w.on('scroll' + bindSuffix, scrollHandler).on('resize' + bindSuffix, resizeHandler);
  scrollHandler();
})();
(function(){
...
(function(){
  var bindSuffix, curPageHashes, pathname, scrollHandler;
  bindSuffix = '.header-menu-auto-detect-current-anchor';
  curPageHashes = {};
  if (mainPage) {
    curPageHashes['#card-1'] = {
      $section: $('#card-1'),
      $navLink: null
    };
  }
  ...
  $navLinks.each(function(){
    if (this.pathname === pathname && hasElByHash(this.hash)) {
      curPageHashes[this.hash] = {
        $section: $(this.hash),
        $navLink: $(this)
      };
    }
  ...
  scrollHandler = function(){
    var st, stof, lastHash, lastTop, hash, ref$, val, elTop, $navLink;
    ...
    lastHash = null;
    lastTop = null;
    for (hash in ref$ = curPageHashes) {
      val = ref$[hash];
      elTop = val.$section.offset().top;
      if (stof >= elTop && (lastTop == null || elTop > lastTop)) {
        lastHash = hash;
        lastTop = elTop;
      }
    }
    if (lastHash != null && lastHash !== window.location.hash) {
      $navLinks.removeClass('active');
      $navLink = curPageHashes[lastHash].$navLink;
      if ($navLink != null) {
...
},{"./basics":1,"./has-el-by-hash":2,"./link-handler":9,"jquery":"tpyseH"}],4:[function(require,module,exports){
/**
...
},{}],"y5h8WQ":[function(require,module,exports){
(function (global){
...
},{"jquery":"tpyseH"}],"jquery.transit":[function(require,module,exports){
module.exports=require('y5h8WQ');
...
},{"jquery":"tpyseH"}],9:[function(require,module,exports){
// Generated by LiveScript 1.3.1
/**
 * Link handler module
 ...
 * @see {@link https://github.com/web-izmerenie/wi-site/blob/master/LICENSE-AGPLv3|License}
 */
var _p, $, b, hasElByHash, $page, $html, $body, $header, $heightHelper, $navLinks, scrolling;
_p = require('prelude');
$ = require('jquery');
b = require('./basics');
hasElByHash = require('./has-el-by-hash');
...
module.exports = function(){
  ...
  if (!hasElByHash(hash)) {
    window.alert(b.getLocalText('err', 'detect-link-anchor', {
      '#LINK_HREF#': href
    }));
    scrolling = false;
  ...
  top = $(hash).offset().top - $heightHelper.height();
  $page.stop().animate({
    'scroll-top': top
  }, b.getVal('animation-speed') * 4, function(){
...
},{"./basics":1,"./has-el-by-hash":2,"jquery":"tpyseH","prelude":"iujHG2"}],10:[function(require,module,exports){
// Generated by LiveScript 1.3.1
/**
 * Site localization
 *
...
b.init(function(){
  var $html, $header, $helper, linkHandler, goToAnchor;
  $html = $('html');
...
},{"./basics":1,"./has-el-by-hash":2,"./header":3,"./link-handler":9,"./pages/general":12,"jquery":"tpyseH","prelude":"iujHG2"}],12:[function(require,module,exports){
// Generated by LiveScript 1.3.1
/**
 ...
 * @see {@link https://github.com/web-izmerenie/wi-site/blob/master/LICENSE-AGPLv3|License}
 */
var _p, $, b, preload, linkHandler, hasElByHash, $w, $html, $page, $body, $header, $logo, $logoImg, $cards, $card1, $card1Bg, $card1Next, speed, loadingAnimation, card1ParallaxInit, loadingLoop, preloadCb, LoadImg, imgSrc;
_p = require('prelude');
$ = require('jquery');
b = require('../basics');
...
$card1Bg = $card1.find('.bg');
$card1Next = $card1.find('.next');
speed = b.getVal('animation-speed');
loadingAnimation = true;
$card1Next.click(linkHandler);
card1ParallaxInit = function(){
  var card1BgParallaxBindSuffix;
  card1BgParallaxBindSuffix = '.card-1-bg-parallax';
  $w.on('scroll' + card1BgParallaxBindSuffix, function(){
    var st, val;
    st = $w.scrollTop();
    if (st > $card1.height()) {
      return;
    ...
    val = st / 2;
    $card1Bg.css('background-position', "center " + val + "px");
  });
  $w.on('resize' + card1BgParallaxBindSuffix, function(){
    $w.trigger('scroll' + card1BgParallaxBindSuffix);
  });
  $w.trigger('resize' + card1BgParallaxBindSuffix);
};
...
preloadCb = function(){
  ...
  $logoImg.stop().transition({
    ...
    $card1Bg.stop().transition({
      opacity: 1,
      scale: 1
    }, speed * 4, 'in-out', function(){
      ...
      setTimeout(function(){
        ...
        if (_p.isType('Function', goToAnchor)) {
          goToAnchor();
        }
      }, speed * 4);
    });
...
b.loadImg(imgSrc, function(err, img){
  if (err) {
    if (err instanceof LoadImg.exceptions.Timeout) {
      window.alert(b.getLocalText('err', 'preload-img-timeout', {
        '#IMAGE_SRC#': imgSrc
      }));
      return;
    }
    window.alert(b.getLocalText('err', 'preload-img', {
...
},{"../basics":1,"../has-el-by-hash":2,"../lib/load_img":8,"../link-handler":9,"../preload":14,"./general/portfolio":13,"jquery":"tpyseH","jquery.transit":"y5h8WQ","prelude":"iujHG2"}],13:[function(require,module,exports){
// Generated by LiveScript 1.3.1
/**
...
},{"jquery":"tpyseH"}],14:[function(require,module,exports){
// Generated by LiveScript 1.3.1
/**
 ...
 * @see {@link https://github.com/web-izmerenie/wi-site/blob/master/LICENSE-AGPLv3|License}
 */
var _p, $, b, error, addPreloadToDom, loadedCb, success;
_p = require('prelude');
$ = require('jquery');
b = require('./basics');
error = function(xhr, status, err){
  if (err === 'timeout') {
    ...
    window.alert(b.getLocalText('err', 'styles', 'xhr-load', {
      '#ERROR_CODE#': err
    }));
  }
};
...
loadedCb = function(cb, loadedList, matches){
  matches = _p.unique(
  matches);
  loadedList = _p.unique(
  loadedList);
  if (_p.empty(
  _p.difference(matches, loadedList))) {
    setTimeout(cb, 0);
  }
};
success = function(data, cb){
  ...
  for (i$ = 0, len$ = matches.length; i$ < len$; ++i$) {
    ...
    b.loadImg(src, (fn$.call(this, src, className)));
  }
...
module.exports = function(cb){
  $.ajax({
    cache: true,
    url: b.getVal('styles-href'),
    dataType: 'text',
    timeout: b.getVal('styles-load-timeout') * 1000,
    type: 'GET',
...
},{"./basics":1,"./lib/load_img":8,"jquery":"tpyseH","prelude":"iujHG2"}],15:[function(require,module,exports){
// Generated by LiveScript 1.3.1
/**
 * General values
 *
...
module.exports=require('tpyseH');
},{}],"tpyseH":[function(require,module,exports){
(function (global){
(function browserifyShim(module, define) {
/*!
